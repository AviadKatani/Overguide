...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MediaManager.Platforms.Android.Media.RatingCallback, MediaManager", RatingCallback.class, __md_methods);
	}
	...
	public RatingCallback ()
	{
		...
		if (getClass () == RatingCallback.class)
			mono.android.TypeManager.Activate ("MediaManager.Platforms.Android.Media.RatingCallback, MediaManager", "", this, new java.lang.Object[] {  });
	}
