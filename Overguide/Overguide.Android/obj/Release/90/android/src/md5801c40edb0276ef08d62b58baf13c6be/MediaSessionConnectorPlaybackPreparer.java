...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MediaManager.Platforms.Android.Media.MediaSessionConnectorPlaybackPreparer, MediaManager", MediaSessionConnectorPlaybackPreparer.class, __md_methods);
	}
	...
	public MediaSessionConnectorPlaybackPreparer ()
	{
		...
		if (getClass () == MediaSessionConnectorPlaybackPreparer.class)
			mono.android.TypeManager.Activate ("MediaManager.Platforms.Android.Media.MediaSessionConnectorPlaybackPreparer, MediaManager", "", this, new java.lang.Object[] {  });
	}
	...
	public MediaSessionConnectorPlaybackPreparer (com.google.android.exoplayer2.ExoPlayer p0, com.google.android.exoplayer2.source.ConcatenatingMediaSource p1)
	{
		super ();
		if (getClass () == MediaSessionConnectorPlaybackPreparer.class)
			mono.android.TypeManager.Activate ("MediaManager.Platforms.Android.Media.MediaSessionConnectorPlaybackPreparer, MediaManager", "Com.Google.Android.Exoplayer2.IExoPlayer, ExoPlayer.Core:Com.Google.Android.Exoplayer2.Source.ConcatenatingMediaSource, ExoPlayer.Core", this, new java.lang.Object[] { p0, p1 });
	}
