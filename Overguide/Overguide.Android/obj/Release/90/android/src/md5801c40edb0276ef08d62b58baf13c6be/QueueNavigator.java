...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MediaManager.Platforms.Android.Media.QueueNavigator, MediaManager", QueueNavigator.class, __md_methods);
	}
	...
	public QueueNavigator (android.support.v4.media.session.MediaSessionCompat p0)
	{
		...
		if (getClass () == QueueNavigator.class)
			mono.android.TypeManager.Activate ("MediaManager.Platforms.Android.Media.QueueNavigator, MediaManager", "Android.Support.V4.Media.Session.MediaSessionCompat, Xamarin.Android.Support.Media.Compat", this, new java.lang.Object[] { p0 });
	}
	...
	public QueueNavigator (android.support.v4.media.session.MediaSessionCompat p0, int p1)
	{
		super (p0, p1);
		if (getClass () == QueueNavigator.class)
			mono.android.TypeManager.Activate ("MediaManager.Platforms.Android.Media.QueueNavigator, MediaManager", "Android.Support.V4.Media.Session.MediaSessionCompat, Xamarin.Android.Support.Media.Compat:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1 });
	}
